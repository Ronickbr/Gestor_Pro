        ...
        <aside className="fixed top-0 left-0 z-40 w-64 h-screen transition-all glass border-r-0 md:translate-x-0 hidden md:flex flex-col shadow-2xl">
            ...
            <div className="p-4 border-t border-white/5 space-y-3">
                <button
                    ...
                    className="w-full bg-primary text-white font-bold py-3 rounded-xl shadow-lg shadow-primary/20 hover:bg-primary-dark hover-lift flex items-center justify-center gap-2"
                >
                ...
                <button
                    ...
                    className="w-full bg-red-500/5 text-red-600 dark:text-red-400 font-bold py-3 rounded-xl hover:bg-red-500/10 transition-all flex items-center justify-center gap-2"
                >
